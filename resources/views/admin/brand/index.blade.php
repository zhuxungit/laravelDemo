...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 品牌管理 <a
...
<div class="page-container">
    <div class="text-c">
        <form class="Huiform" method="post" action="" target="_self">
            ...
            <button type="button" class="btn btn-success" id="add_brand" name="" ><i class="Hui-iconfont">&#xe600;</i> 添加</button>
        </form>
    </div>
    ...
    <div class="mt-20">
        <table id="datatables" class="table table-border table-bordered table-bg table-sort">
            <thead>
            <tr class="text-c">
...
//    });
    ...
    $('#datatables').DataTable({
        ...
        columns:[
            ...
            {data:'site_url'},
            {data:'description'},
            {data:'d',defaultContent:'操作'}
        ]
    });
// 实现品牌的添加
$("#add_brand").click(function(){
    layer_show('品牌添加','{{asset("/brand/brandAdd")}}');
});
